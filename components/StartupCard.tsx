...
const StartupCard = ({ post }: { post: StartupTypeCard }) => {
  ...
  return (
    <li className="bg-white border-[5px] border-black py-6 px-5 rounded-[22px] shadow-200 hover:border-pink transition-all duration-500 hover:shadow-300 hover:border-pink-600 hover:bg-pink-100 group">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-1.5">
          ...
          <span className="text-16-radius">{views}</span>
        </div>
      </div>
